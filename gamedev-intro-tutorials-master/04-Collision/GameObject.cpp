...
bool CGameObject::IsCollision(LPGAMEOBJECT object)
{
	...
	if (CGame::GetInstance()->CheckAABB(Left1, right1, top1, bottom1, Left2, right2, top2, bottom2))
		return true;
	LPCOLLISIONEVENT e = SweptAABBEx(object);
	bool res = e->t > 0 && e->t <= 1.0f; // dk vcham
	return res;
